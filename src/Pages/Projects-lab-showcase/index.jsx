  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {currentPanel === storyPanels.length - 1 && (
        ...
        >
          <div className="bg-card/95 backdrop-blur-terminal border border-border rounded-terminal p-6 terminal-window text-center">
            <h3 className="text-lg font-bold text-foreground mb-2">Ready to Collaborate?</h3>
            <p className="text-sm text-muted mb-4">Let's build something amazing together</p>
            <div className="flex space-x-3">
              <Button
                variant="default"
                size="sm"
                onClick={() => navigate('/projects-lab-showcase')}
                iconName="Code2"
                iconPosition="left"
              >
                View Projects
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => navigate('/ai-assistant-chat-interface')}
